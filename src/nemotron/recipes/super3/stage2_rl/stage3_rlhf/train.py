...
"""RLHF (RL from Human Feedback) training for Nemotron Super3.
...
CLI:
    nemotron super3 rl stage3_rlhf              # local execution
    nemotron super3 rl stage3_rlhf --run dgx    # submit to cluster

Execution logic: src/nemotron/cli/commands/super3/rl/stage3_rlhf.py
...
def main() -> None:
    ...
    patch_wandb_local_file_handler_skip_digest_verification()
    patch_wandb_runid_for_seeded_random()
    patch_nemo_rl_checkpoint_logging(artifact_name="super3-rl-rlhf-model")
