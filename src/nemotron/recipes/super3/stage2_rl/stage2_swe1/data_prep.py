...
"""Data preparation for SWE Stage 1 (SWE-Pivot).

Splits the local swe1.jsonl file into train/val (last 100 rows → val).
No HF placeholder resolution needed — data is already complete.

CLI:
    nemotron super3 data prep rl swe1
    nemotron super3 data prep rl swe1 sample=1000
